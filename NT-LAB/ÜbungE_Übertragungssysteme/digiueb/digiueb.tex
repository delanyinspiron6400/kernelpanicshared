...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{figures/Aufgabe2_16QAM.jpg} 
\caption{Test}
\end{figure}
...
\subsection{Diskussion}
\begin{enumerate}
\item Verzerrungen beurteilen anhand Spektrums, bei höheren Frequenzen hängt das Spektrum, werden etwas gedämpft. Hochfrequenze Störungen sollten gefilter werden
...
Da haben wir nix dazu augeschrieben!
