...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{figures/a1.eps} 
...
\subsection{Aufgabenstellung}
Bei dieser Aufgabe, galt es die Amplituden der beiden Seitenbänder der Rückmodulation vom Transponder zu ermitteln. Hierfür wurde die Helmholz-Anordnung verwendet. Mit Hilfe des Verstärkers wurden die Seitenbänder bei einer magnetischen Feldstärke von 1-6A/m eingestellt. 
\begin{itemize}
\item???.
\end{itemize}
